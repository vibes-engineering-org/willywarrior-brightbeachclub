export const PROJECT_TITLE = "BrightBeachClub";
export const PROJECT_DESCRIPTION = "Exclusive beachside community and lifestyle hub";
export const PROJECT_CREATOR = "willywarrior";
